...
|-----------|------------|-----------|
| Language | Go 1.26.5 (from `go.mod`) | Statically compiled binary, strong stdlib HTTP, goroutine concurrency |
...
|------|---------|---------|
| [Go](https://go.dev/dl/) | 1.26.5 (see `go.mod`) | Language runtime and compiler |
